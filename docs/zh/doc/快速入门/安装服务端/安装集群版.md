...
curl --location --request POST 'http://127.0.0.1:8090/naming/v1/instances' \
--header 'Content-Type: application/json' \
--data-raw '[{"service":"polaris.redis","namespace":"Polaris","weight":100,"healthy":true,"isolate":false,"port":${redis_port},"host":"${redis_host}","enable_health_check":false,"metadata":{}}]'
```
