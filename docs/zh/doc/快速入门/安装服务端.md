...
在Polaris的[releases](https://github.com/polarismesh/polaris/releases)上获取到Polaris的所有版本以及相关介绍。推荐使用最新的稳定版本。
...
在浏览器，输入http://控制台IP:8080/（单机版的话，控制台IP为127.0.0.1），可以打开控制台页面
![console](console.png)

### 创建服务

点击“新建”按钮，填好服务基本信息后，能成功创建服务
![console](create_service.png)
